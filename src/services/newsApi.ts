...
// export const fetchRelatedArticles = async (params: RelatedArticlesType): Promise<Article[] | null> => {

//     const url = `https://eventregistry.org/api/v1/article/getArticles`;

//     const { category, excludeId, limit } = params;

//     var attempts = 0;
//     const maxAttempts = 3;

//     // key: string will allow me to add more properties without TS crying
...
//                 attempts++;
//                 if (attempts >= maxAttempts) {
//                     console.error("Error fetching related articles. Max attempts reached.");
//                     return null;
//                 }
//             }
//         }
